...
- **`gutenberg`** (`src/ingest/gutenberg.js`) — **whole books, read entire.** Search the Project
...
- **The Wikimedia sister projects** (`src/ingest/wikimedia.js`) — one factory covers the shelf
