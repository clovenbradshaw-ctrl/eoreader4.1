...
// the holon principle on the generation side: the high (a branch) is wholly a
// function of the low (its leaves). When a leaf completes, its status flips and
// every ancestor's rollup recomputes — the graph "updates as each step is
// completed" without any node being told to update.
...
// The cited sources, folded across every leaf, de-duped and ordered — the task
// graph's `arcSources` equivalent.
