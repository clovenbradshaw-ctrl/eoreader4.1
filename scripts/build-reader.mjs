...
<!-- The LENS layer (src/workspace/lens.js): named workspaces laid over the shared Record —
     each pins a slice of memory, carries its own accent, and remembers how its panel was
     organized. It is the grounding spine: "narrow to workspace" grounds a chat in the active
